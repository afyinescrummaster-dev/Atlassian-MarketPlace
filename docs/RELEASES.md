...
|---|---|---|---|---|---|
| Delivery Intelligence | `di-v1.1.0` | `a25cd5b` | development | **2.18.0** | Sprint Intelligence. Live verify is `deploy/di/development/2.18.0` (`4bb252d`). |
...
|---|---|---|---|
| `di-v1.1.0` | 2026-09-10 | `a25cd5b8b87653560ac9fa629c9d41fc72a65428` | **Sprint Intelligence.** V1 plus Scope Movement, actionable attention items, in-report issue drill-downs, current vs previous completed sprint, and distinct natural-language Rovo intents. Live Forge development 2.18.0. Compare later major work against this tag; keep `di-v1.0.0` as the V1 baseline. |
| `di-v1.0.0` | 2026-08-29 | `c780ff5462fb9c74fa8cbba37f5a104d5401a524` | **V1 — Sprint Health + Rovo Intelligence.** Deterministic sprint health, original-commitment reconstruction, scope growth, carryover, blocked/stale, health score, Rovo explain/recommend/brief, verified PLAT acceptance behavior, recovered Git baseline, and CMS-style Forge deploy/rollback. |
...
```bash
# Official current milestone
./scripts/release-rollback.sh di 1.1.0 development
...
```bash
./scripts/rollback-deployment.sh di development 2.18.0
```
