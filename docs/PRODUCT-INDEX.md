...
|---|---|---|---|
| **Delivery Intelligence** (new) | `docs/products/delivery-intelligence.md` | `apps/delivery-intelligence/` | Separate app — current `di-v1.1.0`. V1 baseline `di-v1.0.0` @ `c780ff5`. Historical recovered known-good: `di-v0.1.1` @ `4f44eb3`. |
