...
|---|---|---|---|---|---|---|
| Delivery Intelligence | `deploy/di/development/3.2.0` | `e380bedd6a0c` | `development` | **3.2.0** | 2026-09-22T00:30:26Z | Deployed from clean e380bedd6a0c via scripts/forge-deploy.sh |
