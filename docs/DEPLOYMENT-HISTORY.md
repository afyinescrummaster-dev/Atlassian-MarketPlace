...
|---|---|---|---|---|---|---|
| Delivery Intelligence | `deploy/di/development/3.1.0` | `b1a1cebac03a` | `development` | **3.1.0** | 2026-09-21T23:47:51Z | Deployed from clean b1a1cebac03a via scripts/forge-deploy.sh |
