...
|---|---|---|---|---|---|---|
| Delivery Intelligence | `deploy/di/development/2.16.0` | `1523b754c90b` | `development` | **2.16.0** | 2026-08-29T21:36:52Z | Deployed from clean 1523b754c90b via scripts/forge-deploy.sh |
